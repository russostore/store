...
export function ProductCard({ product, index }: Props) {
  const waLink = buildWhatsappUrl(product);
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-[#1a1a1f] to-[#0a0a0c]">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5">
          ...
          {discount > 0 && (
            <span className="inline-flex items-center rounded-full bg-[#8b1a1a] px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-white">
              -{discount}%
            </span>
          )}
        </div>
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <a
          ...
          className="mt-4 group/btn relative overflow-hidden rounded-xl bg-[#25D366] hover:bg-[#1ebe5d] px-4 py-3 text-sm font-bold text-black transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/15 hover:shadow-[#25D366]/30"
        >
          {/* Efeito shimmer */}
          ...
          <span className="relative">Comprar via WhatsApp</span>
